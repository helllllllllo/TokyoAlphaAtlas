...
rows += [
    ...
    # survivor rows sit AT the designed 2023 median so they don't shift any golden median
    ["中古マンション等", "中野区", "x", "中野", "5", "33000000", "50", "不明", "2023年第4四半期"],
    ...
    # survivor rows sit AT the designed 2023 median so they don't shift any golden median
    ["中古マンション等", "中野区", "x", "中野", "5", "33000000", "50", "", "2023年第4四半期"],   # blank 建築年 — survives, built_year=None
